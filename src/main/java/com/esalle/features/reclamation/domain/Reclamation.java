package com.esalle.features.reclamation.domain;
...
public class Reclamation {
    ...
    public enum Urgence {
        ...
        MOYENNE,  // Urgence moyenne (ex: matériel défectueux)
        ELEVEE    // Urgence élevée (ex: sécurité, urgent)
    }
    ...
    /**
     * Vérifie si la réclamation est urgente (ELEVEE)
     */
    public boolean isUrgente() {
        return urgence == Urgence.ELEVEE;
    }
